...
Rails.application.config.after_initialize do
  OpenProject::Notifications.subscribe(OpenProject::Events::JOURNAL_CREATED) do |payload|
    ...
    # A job is scheduled immediately that handles addiitional workflows on work packages
    WorkPackages::WorkflowJob.perform_later(journal) if journal.journable_type == "WorkPackage"
